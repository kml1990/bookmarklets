        ...
        var doc = document.documentElement,
            ...
            saveGrid = function () {
                ...
                while (gridName === "" && guidesCnt > 0) {
                    ...
                    if (gridName !== "" && gridName !== false && gridName !== null && window.localStorage) {
                        for (i in guides) {
                            if (guides.hasOwnProperty(i)) {
                                gridData[i] = { cssClass: guides[i].className, style: guides[i].style.cssText };
                            }
                        }
            ...
            Menu = function () {
                var menuList = null,
                    ...
                    toggles = {},
                    menuItemsList = [
                        { text: "Hide rulers", hotkey: "Ctrl + Alt + R", alias: "rulers" },
                        { text: "Hide guides", hotkey: "Ctrl + Alt + G", alias: "guides" },
                        { text: "Hide all", hotkey: "Ctrl + Alt + A", alias: "all" },
                        { text: "Unlock rulers", hotkey: "Ctrl + Alt + L", alias: "lock" },
                        { text: "Clear all guides", hotkey: "Ctrl + Alt + D", alias: "clear" },
                        { text: "Open grid", hotkey: "Ctrl + Alt + O", alias: "open" },
                        { text: "Save grid", hotkey: "Ctrl + Alt + G", alias: "save" },
                        { text: "Snap to", hotkey: "Ctrl + Alt + C", alias: "snap" },
                        { text: "Show detailed info", hotkey: "Ctrl + Alt + I", alias: "details" },
                        { text: "Snap to DOM", hotkey: "Ctrl + Alt + E", alias: "snapdom" },
                    ],
                    i = 0;
                this.render = function () {
                    ...
                    for (i; i < menuItemsList.length; i = i + 1) {
                        ...
                        toggles[menuItemsList[i].alias] = { obj: liLink, txt: liDescTxt };
                    }
            ...
            prepare = function () {
                ...
                setTimeout(function () {
                    hRuler = new Ruler("h", 5000);
                    vRuler = new Ruler("v", 20000);
